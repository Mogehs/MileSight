...
import cam from "/iot-controller/5g-aiot-4x12x-pro-bullet-plus-camera.png";
import vandal from "/iot-controller/lorawan-5g-cpe-uf51.png";
import statics from "/iot-controller/lorawan-5g-router-ur75.png";
import { useMenu } from "../../menueContext";

export default function Five({ filter }) {
