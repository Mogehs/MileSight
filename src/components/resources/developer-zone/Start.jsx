  ...
  return (
    ...
    >
      ...
      <div className="relative text-white px-8 flex flex-col justify-center gap-6 md:items-start items-center max-w-3xl">
        <h1 className="text-4xl md:text-6xl font-semibold text-center text-nowrap sm:text-left">
          Developer Zone
        </h1>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <button className="flex items-center gap-3 bg-[#00667C] text-white px-6 py-3 rounded-md font-semibold hover:bg-[#7CCA9A] transition">
            <FaUsers size={20} />
            Join Our Community
          </button>
          <button className="flex items-center gap-3 bg-[#7CCA9A] text-white px-6 py-3 rounded-md font-semibold hover:bg-gray-300 transition ">
            <p className="text-center sm:text-left"> Resource Hub</p>
          </button>
        </div>
      </div>
    </div>
