...
const BackgroundSection = () => {
  return (
    <>
      <div className="relative bg-cover bg-center text-black py-16 px-6 text-center sm:text-left flex flex-col items-center">
        <h2 className="text-4xl font-semibold">Learn, Build, and Connect</h2>
      </div>
      <div
        className="relative bg-cover bg-center text-white mx-10 rounded-md py-16 px-2 flex flex-col items-center"
      ...
      >
        ...
        <div className="relative z-10 mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
          ...
          <div className="bg-white rounded-md p-6 shadow-lg text-center">
            ...
            <h4 className="mt-4 text-lg text-[#0299F4] underline">
              User Guide{" "}
            </h4>
            <h4 className="text-lg text-[#0299F4] underline">Dev Guide</h4>
            <button className="mt-6 bg-[#7CCA9A] text-white px-4 py-2 rounded-lg hover:bg-[#00667C]">
              Get Started
            </button>
          </div>
