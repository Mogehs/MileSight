...
export default function BuildingSection() {
  ...
  const data = [
    {
      id: 1,
      img: "/resources/solution-training/building-img1.jpg",
      title: "Milesight Smart Restroom Solution using LoRaWAN®",
      url: "https://www.youtube.com/embed/6G60mNPDen8",
    },
    {
      id: 2,
      img: "/resources/solution-training/building-img2.jpg",
      title: "Milesight Smart Restroom Solution using LoRaWAN®",
      url: "https://www.youtube.com/embed/eDNZb84bPis",
    },
  ];
          ...
          <div className="flex md:flex-row flex-col items-center p-4">
            {data.map((item, index) => (
              ...
              >
                ...
                <div
                  onClick={() => setActiveVideo(item.url)}
                  className="absolute top-25 left-35 md:left-40 md:top-30 -translate-x-1/2 -translate-y-1/2 bg-[#38313153] p-3 rounded-full shadow-lg cursor-pointer transition hover:bg-[#ff0000]"
                >
                  <Youtube size={22} className="text-white" />
                </div>

                {/* Title */}
                <p className=" mt-2 text-sm text-[#333] md:w-[80%] lg:w-[80%]">
                  {item.title}
                </p>
              </div>
            ))}
