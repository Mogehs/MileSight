...
const Start = () => {
  return (
    ...
    >
      ...
      <div className="absolute pt-20 px-3 sm:float-right flex flex-col justify-center  items-center sm:flex sm:flex-col sm:right-0 sm:top-7 sm:p-3  text-white bg-[#00000060] rounded w-[35rem]">
        <h1 className="sm:text-4xl w-full  text-2xl font-bold">ABOUT MILESIGHT</h1>
        <span className=" ">
