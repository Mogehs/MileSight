  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-6xl mx-auto py-10 px-6">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center md:pl-8 bg-gray-50 min-h-[16rem] md:min-h-[24rem] p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">{carouselData[currentIndex].title}</h2>
