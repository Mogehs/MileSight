...
export default function ParkingManage() {
    ...
    return (
        <div className=" w-full h-fit mt-4">
            <div className=" w-full flex justify-center flex-col  mx-auto sm:w-11/12 h-20 sm:h-30 rounded-md " style={{ backgroundImage: `url(${parking})`, backgroundSize: '100% 100%' }}></div>
