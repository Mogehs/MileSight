...
export default function TrafficManagement() {
  const data = [
    ...
    {
      img: airoad,
      title: "AI Road Traffic Pro Bullet Plus Camera",
      description: "For More Demanding Traffic Applications",
      li: "Powerful AI ISP Embedded",
      li1: "250km / h High Speed Capture with Global Shutter",
      li3: "Dual- lens for Overview and ANPR Image",
    ...
    {
      img: aiplus,
      title: "AI Road Traffic Supplement Light Pro Bullet Plus Camera",
      description: "Red Light Violation Detection",
      li: "Edge AI Deep Learning Technology",
      li1: "Multiple Traffic Light Detection Methods: Based on Image or Signal Inputs",
      li3: "Accurately Capture Video Evidence of Vehicles that Run Red Lights",
    ...
    {
      img: ptz2,
      title: "AI Road Traffic PTZ Bullet Camera",
      description: "Red Light Violation Detection",
      li: "Edge AI Deep Learning Technology",
      li1: "Multiple Traffic Light Detection Methods: Based on Image or Signal Inputs",
      li3: "Accurately Capture Video Evidence of Vehicles that Run Red Lights",
    ...
    {
      img: ptz3,
      title: "AI Road Traffic Speed Dome Camera",
      description: "For More Demanding Traffic Applications",
      li: "Powerful AI ISP Embedded",
      li1: "250km / h High Speed Capture with Global Shutter",
      li3: "Dual- lens for Overview and ANPR Image",
    ...
    {
      img: airoad,
      title: "AI Road Traffic Parking Detection Pro Bullet Plus Camera",
      description: "Red Light Violation Detection",
      li: "Edge AI Deep Learning Technology",
      li1: "Multiple Traffic Light Detection Methods: Based on Image or Signal Inputs",
      li3: "Accurately Capture Video Evidence of Vehicles that Run Red Lights",
  ...
  return (
    <div className="w-full h-fit mt-4">
      <div
        className=" w-full flex justify-center flex-col  mx-auto sm:w-11/12 h-20 sm:h-30 rounded-md "
        style={{
          backgroundImage: `url(${trafficmanage})`,
          backgroundSize: "100% 100%",
        }}
      >
        <h1 className="text-white sm:px-4 text-xs sm:text-2xl sm:text-nowrap text-wrap">
      ...
      <div className=" w-full mx-auto sm:w-11/12 h-fit sm:mt-6 mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        {data.map((item, index) => (
          <div
            className=" w-full h-fit flex px-2 flex-col lg:flex-row justify-center items-center pr-2  border border-gray-300 rounded-md cursor-pointer hover:shadow hover:shadow-gray-400"
            key={index}
          >
