...
export default function Inteligent() {
  const data = [
    {
      ...
      description:
        "Milesight pioneers the fusion of video surveillance, AI, ANPR, 3D Radar, Global Shutter, Dual-lens, IoT and more to redefine traffic management and elevate road safety. Discover how Milesight shapes a smarter and safer traffic and be part of the revolution.",
      trf1,
      trf2,
      trf3,
      trf4,
  ...
  return (
    <div
      className=" w-full h-[60vh] sm:h-[80vh] flex justify-center flex-col"
      style={{ background: `url(${intelgent})`, backgroundSize: "cover" }}
    >
      <div className=" flex justify-start items-center flex-col w-full sm:w-[40%] h-[50vh] ">
        {data.map((item, index) => (
          <div className=" text-white px-10" key={index}>
            ...
            <div className="flex justify-center flex-col items-center w-full mt-3 lg:w-[30%] rounded-lg py-2 cursor-pointer border border-gray-400 transition-all duration-300 hover:bg-[#00667C]">
