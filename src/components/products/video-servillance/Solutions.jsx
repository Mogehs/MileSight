...
export default function Solution() {
  return (
    <div className=" w-full mt-10">
      <h1 className="sm:text-start text-center sm:px-10 text-2xl sm:text-4xl font-semibold ">
        Solution
      </h1>
      ...
      <div className=" flex flex-col lg:flex-row gap-4 mt-10 sm:w-[90%] md:mx-auto w-full">
        ...
        <div className="grid grid-flow-col p-3 grid-rows-1 sm:grid-rows-3 gap-4 w-full md:w-[100%]">
          ...
          >
            ...
            <p>
              Traffic Insights to Improve Safety <br /> and Mobility
            </p>
          </div>
          <div
          ...
          >
            ...
            <p>
              Unparalleled Anonymous <br /> Counting
            </p>
          </div>
          <div
            className="col-span-2 row-span-2 p-2"
            style={{
        ...
        <div className="grid grid-flow-col grid-rows-3 p-3 gap-4 w-full md:w-[100%]">
          ...
          >
            ...
            <p>
              Full 180°/360° Panoramic <br /> Viewing Experience
            </p>
          </div>
          <div
            className="col-span-2 p-2"
          ...
          >
            <h1 className=" text-white font-semibold text-xl sm:text-2xl mb-2">
              Smart Remote <br />
              Managment <br />
              Solution
            </h1>
            <p className=" text-white">
              Easy and Remote <br /> Management in Batch
            </p>
          </div>
          <div
            className="col-span-2 row-span-2 p-2"
          ...
          >
            ...
            <p>
              Monitor Large Areas with <br /> Flexible PTZ Functions
            </p>
          </div>
        </div>
      </div>
      <a
        href="/solutions/intelligent-traffic-solution"
