...
export default function AiVideo() {
    const array = [
        "Product", "What's Hot", "Innovation", "Solution", "Case", "Integration", "Support", "Contact"
    ];
    
    const product = [
        "Mini Series", "Pro Series", "PTZ Series", "Panoramic Series",
        "Intelligent Traffic", "Solar-powered Series"
    ];
        ...
        <div className="w-full">
            <div className="w-full sm:w-[90%] mx-auto">
                ...
                <div className="mb-5 sm:mb-10">
                    <h1 className="text-xl sm:text-2xl font-semibold hidden sm:inline">AI Video Surveillance</h1>
                    <div className="w-full flex justify-between sm:mt-3">
                        <div className="sm:flex flex-wrap gap-10 hidden">
                            {array.map((item, index) => (
                                <p key={index} className="text-nowrap text-gray-400 hover:text-blue-400 cursor-pointer">{item}</p>
                            ))}
                        </div>

                        <div className="flex gap-2">
                            <p className="text-gray-400 hover:text-blue-400 cursor-pointer">Home-</p>
                            <p className="text-gray-400 hover:text-blue-400 cursor-pointer">Security</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-wrap gap-3">
                    {product.map((item, index) => (
                        <div 
                            ...
                            className={`border px-4 py-2 transition-all ease-in-out delay-100 hover:bg-blue-300 hover:shadow-md hover:shadow-blue-200 cursor-pointer rounded-3xl border-gray-500 ${
                                selectedProduct === item ? "bg-blue-300" : ""
                            }`}
                        >
