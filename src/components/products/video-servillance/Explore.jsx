            ...
            <div className="grid grid-cols-1  gap-4">
                ...
                <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3'>
                    ...
                    >
                        ...
                        <div className="absolute bottom-[-20px] group-hover:bottom-10 transition-all duration-300 ease-in-out">
                            <p className="text-xs">Create a better environment for staff and students</p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="absolute bottom-[-20px] group-hover:bottom-10 transition-all duration-300 ease-in-out">
                            <p className="text-xs">Increasing efficiency, reducing security risks</p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="absolute bottom-[-20px] group-hover:bottom-10 transition-all duration-300 ease-in-out">
                            <p className="text-xs">Protecting government facilities and public safety</p>
                        </div>
                    </div>
                </div>
                ...
                <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3'>
                    ...
                    >
                        ...
                        <div className="absolute bottom-[-20px] group-hover:bottom-10 transition-all duration-300 ease-in-out">
                            <p className="text-xs">Ensuring a secure healthcare environment</p>
                        </div>
                    </div>
                    ...
                    <div className="  bg-cover bg-center p-4 flex items-end justify-center">
                        <div className="flex justify-center items-center flex-col">
                            <h1 className="text-xl lg:text-3xl font-semibold">Explore Success Cases</h1>
                            <div className="flex justify-center flex-col items-center w-full lg:w-[70%] rounded-2xl py-2 cursor-pointer mt-2 border border-gray-400 transition-all duration-300 bg-gray-200 hover:bg-gradient-to-r from-blue-300 to-blue-500">
                ...
                <div className=' w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3'>
                    ...
                    >
                        ...
                        <div className="absolute bottom-[-20px] group-hover:bottom-10 transition-all duration-300 ease-in-out">
                            <p className="text-xs">Boosting security, efficiency, and eco-friendliness</p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="absolute bottom-[-20px] group-hover:bottom-10 transition-all duration-300 ease-in-out">
                            <p className="text-xs">Enhance Security, analyze customer flow, maximize business</p>
                        </div>
                    </div>
                    ...
                    >
                        <p className="font-semibold text-xl md:text-2xl">Residential Safety</p>
                        <div className="absolute bottom-[-20px] group-hover:bottom-10 transition-all duration-300 ease-in-out">
                            <p className="text-xs">Monitors surroundings and safeguard property</p>
                        </div>
                    </div>
                </div>
