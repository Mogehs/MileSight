...
export default function Whatshot() {
    ...
    const slider = [
        { title: "AI Multi-directional Network Camera", decription: "Capture Directional Visions in One Camera", img: mulitcam },
        { title: "Solar-powered Camera Series", decription: "All-in-one Security Kit Green and efficient!", img: off },
        { title: "AI Dual-sensor 180° Panoramic Camera", decription: "Wider Coverage, Sharper Vision, Zero Distortion", img: threed },
        { title: "TrafficX Cameras Series", decription: "Wider Coverage, Sharper Vision, Zero Distortion", img: traffic },
        { title: "TrafficX Cameras Series", decription: "Wider Coverage, Sharper Vision, Zero Distortion", img: cameraseries },
        { title: "TrafficX Cameras Series", decription: "Wider Coverage, Sharper Vision, Zero Distortion", img: one },
    ];
