...
export const  Card=({ item })=> {
    ...
    return (
        ...
        >
            ...
            <div className={` w-full mx-auto sm:w-[80%] text-center transition-all ease-in delay-100 py-2  rounded-4xl bg-blue-300  duration-300 ${isHovered ? 'opacity-100 h-[40px]' : 'opacity-0 h-0'}`}>
