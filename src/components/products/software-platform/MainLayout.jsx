      ...
      <div className="sm:w-11/12 mx-auto w-full">
        <div className="flex justify-between items-center flex-wrap p-3">
          <div className="flex">
            {traffic.map((item) => (
              <div
                ...
                className={`flex justify-center items-center min-w-[100px] sm:min-w-[100px] h-[40px] cursor-pointer px-3 transition-all delay-75 ease-in ${
                  selectedSection === item.key
                    ? "text-[#7CCA9A] underline py-2"
                    : ""
                }`}
              >
                <span className="sm:text-xl text-xs flex items-center gap-1">
                  <span className="rotate-[300deg]">{item.icon}</span>
                  {item.label}
                </span>
              </div>
            ))}
          ...
          <div className="flex gap-2 mt-2">
            <p className="text-xs sm:text-xl text-gray-400 cursor-pointer">
              Home
            </p>
            <p className="text-xs sm:text-xl text-gray-400 cursor-pointer">
              - Product
