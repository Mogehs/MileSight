...
export default function PairUp() {
    ...
    return (
        <div className="w-full h-fit mt-4 p-4">
            <h1 className='text-center font-semibold md:text-4xl mb-4'>Pair up Our Products to Unlock Features</h1>
                ...
                {data.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="mt-2 gap-2 w-full">
                            ...
                            {item.title2 && <h1 className="text-lg font-semibold mt-2">{item.title2}</h1>}
                            <ul className="mt-2 text-sm text-gray-500 list-disc marker:text-blue-500 pl-4">
                            ...
                            <div className='flex justify-between items-center mt-4'>
                                ...
                                {item.btn && (
                                    <button className='text-xs lg:text-lg rounded-2xl bg-blue-500 text-white px-4 py-2 mt-2 scale-[0.6] transform transition-all ease-in delay-100 hover:scale-[0.9] cursor-pointer'>
                                        {item.btn}
                                    </button>
                                )}
                            </div>
