...
export default function Indoor() {
    const data = [
        {
            title: "Did you know that heating and cooling buildings uses a lot of energy?", description: "According to USEPA, it could be up to 43 percent of all energy use in the United States. The main purposes of a Heating, Ventilation and Air-Conditioning (HVAC) system are to help maintain good indoor air quality (IAQ) through adequate ventilation with filtration and provide thermal comfort. HVAC systems are among the largest energy consumers in schools.In Demand Controlled Ventilation (DCV), IAQ sensors and IoT controllers are great helpers which are commonly used to measure the air composition in ventilation units to monitor and adjust the performance of HVAC systems and other indoor air quality management strategies.", btn: "Check How Milesight Helps Worldwide", img: acroom
        }
    ]
    return (
        <div className=" w-full">
            <div className="w-full sm:w-11/12 mx-auto sm:mt-8 mt-4">
                ...
                <div className=" flex gap-4 mt-2 md:mt-8 px-4">
                    {
                        data.map((item, ind) => (
                            <div key={ind} className=" w-full grid grid-cols-1 md:grid-cols-2 gap-4">
