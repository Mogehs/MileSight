...
function NavSection() {
  ...
  return (
    <div className="sticky hidden md:flex top-18 bg-white z-50">
      <div className="btns text-[#666] w-full flex flex-row justify-between px-8 items-center shadow-2xs border-b-[#f5f5f5] py-4">
        <div className="flex flex-row items-center gap-8">
          {[
            { id: "smart-restroom", label: "Smart Restroom" },
            { id: "smart-benefit", label: "Benefit" },
            { id: "smart-products", label: "Products" },
            { id: "smart-application", label: "Typical Application" },
          ].map(({ id, label }) => (
            <button
              key={id}
