...
import enbg from "/Enricheds/enbg.jpg";
import div1 from "/Enricheds/div1.jpg";
import div2 from "/Enricheds/div2.jpg";
import div3 from "/Enricheds/div3.jpg";
import div4 from "/Enricheds/div4.jpg";
import div11 from "/Enricheds/div11.png";
import div22 from "/Enricheds/div22.png";
import div33 from "/Enricheds/div33.png";
import div44 from "/Enricheds/div44.png";
...
export default function Enriched() {
    ...
    const data = [
        { key: "div1", img: div1, title: "Urban Roadway", icon: <IoMdRadioButtonOn /> },
        { key: "div2", img: div2, title: "Intersection", icon: <IoMdRadioButtonOn /> },
        { key: "div3", img: div3, title: "On-Street", icon: <IoMdRadioButtonOn /> },
        { key: "div4", img: div4, title: "Highway", icon: <IoMdRadioButtonOn /> },
    ];

    return (
        <div className="w-full bg-cover" style={{ backgroundImage: `url(${enbg})` }}>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="w-full md:w-[75%] relative ">
                        <div className="relative w-full h-full rounded-lg">
                            {/* Main Image */}
                            <img src={selectedImage.main} alt="Main" className="w-full rounded-lg h-full object-cover" />
                            {/* Overlay Image */}
                            <img src={selectedImage.overlay} alt="Overlay" className="w-full  rounded-lg h-full absolute top-0 z-20 object-cover" />
                        </div>
                    </div>
                    ...
                    <div className=" grid grid-cols-2 gap-2 w-full md:flex md:flex-col md:w-[20%]">
                        {data.map((item) => (
                            ...
                            >
                                {/* Image */}
                                <img src={item.img} alt={item.title} className="w-3/3 rounded-lg object-cover" />
                                {/* Content (Text + Icon) */}
