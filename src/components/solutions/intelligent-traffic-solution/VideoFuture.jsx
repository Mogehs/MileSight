...
export default function VideoFuture() {
  ...
  const data = [
    ...
    {
      img: vid3,
      title: "Outdoor Parking Occupancy Detection",
      url: "https://www.youtube.com/embed/gwVVTiLG4rY",
    },
    {
      img: vid4,
      title: "Outdoor Parking LPR Detection",
      url: "https://www.youtube.com/embed/JjO_TbKHd30",
    },
    {
      img: vid5,
      title: "Illegal Parking Detection",
      url: "https://www.youtube.com/embed/XhtrUR2GO7k",
    },
    {
      img: vid6,
      title: "VMS Enterprise Server Based ANPR",
      url: "https://www.youtube.com/embed/tAhszaHrceI",
    },
    {
      img: vid7,
      title: "White LED Supplement Light",
      url: "https://www.youtube.com/embed/wn18oEzY5yk",
    },
  ];
  ...
  return (
    <div className="relative w-full mx-auto mt-10">
      ...
      <div className="absolute  hidden right-4 top-0 gap-2 z-10">
        <button
      ...
      {/* Slider Container */}
      <div className="relative overflow-scroll w-full sm:w-[90%] mx-auto overflow-y-hidden">
        <div
          ref={sliderRef}
          ...
          {data.map((item, index) => (
            <div key={index} className="relative cursor-pointer group">
              ...
              >
                <Youtube
                  size={22}
                  className="text-white group-hover:text-[#00667C]"
                />
              </div>
