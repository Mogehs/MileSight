      ...
      <div className="w-full max-w-screen-xl px-6 flex flex-col items-center">
        ...
        <div className="w-full sm:w-3/4 md:w-2/3 py-2">
          <p className="text-base sm:text-lg md:text-sm font-light">
            Waste management is crucial in today's world, where environmental
            concerns and resource management are a top priority. In the context
            of <span className="text-blue-600">smart city</span> development,
            Milesight Smart Waste Management Solutions can help monitor the fill
            level of garbage bins, the status of the trash bin lid, and trash
            combustion, which plays a significant role in optimizing waste
